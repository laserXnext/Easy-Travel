...
const AddHotel = () => {
  ...
  const [hotel_available, setHotelavailable] = useState('');
    ...
    if (hotel_id) {
      gethotel(hotel_id)
        .then((response) => {
          ...
          setHotelavailable(data.hotel_available);
        })
        .catch((error) => {
          console.error('Error fetching data', error);
        });
      ...
      if (hotel_id) {
        updatehotel(hotel_id, hotel)
          .then((response) => {
            ...
            navigate(`/admin/${verificationCode}`);
          })
          .catch((error) => {
      ...
      <div className='addhotel'>
        <form>
          ...
          <div className='addr-field'>
            ...
            <input type='text' placeholder='Enter Country' value={hotel_country}  name='hotel_country'onChange={(e) => setHotelcountry(e.target.value)} required/>
          </div>
          <label>Rating</label>
          ...
          <select value={hotel_available} onChange={(e) => setHotelavailable(e.target.value)} required>
